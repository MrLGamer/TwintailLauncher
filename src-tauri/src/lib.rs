...
use crate::commands::network::{cache_live_background, check_network_connectivity, cleanup_live_background_cache};
...
pub fn run() {
    ...
    let builder = {
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            Ok(())
        }).invoke_handler(tauri::generate_handler![open_uri, open_folder, empty_folder, open_in_prefix, list_settings, update_settings_third_party_repo_updates, update_settings_default_game_path, update_settings_default_xxmi_path, update_settings_default_fps_unlock_path, update_settings_default_jadeite_path, update_settings_default_prefix_path, update_settings_default_runner_path, update_settings_default_dxvk_path, update_settings_default_mangohud_config_path, update_settings_download_speed_limit_cmd, update_settings_launcher_action, update_settings_manifests_hide, update_settings_hide_app_tray, update_settings_linux_experimental_live_backgrounds_cmd,
            ...
            add_installed_runner, remove_installed_runner, get_installed_runner_by_version, get_installed_runner_by_id, list_installed_runners, update_installed_runner_install_status, is_steamrt_installed, cache_live_background, cleanup_live_background_cache, check_network_connectivity, check_app_update, get_locale, list_locales, update_settings_app_lang_cmd])
